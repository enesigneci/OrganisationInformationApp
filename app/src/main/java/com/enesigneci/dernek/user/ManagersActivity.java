...
public class ManagersActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final MembersAdapter membersAdapter=new MembersAdapter(ManagersActivity.this,userList);
        memberList.setAdapter(membersAdapter);
        db.collection("manager").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
